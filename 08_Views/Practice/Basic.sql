...
-- Exercise 6
-- Create a view that displays players whose jersey numbers are greater than 15.
...
-- Exercise 9
-- Create a view that displays country names and the number of players in each country.
...
FROM COUNTRY
JOIN PLAYER ON COUNTRY.COUNTRY_ID = PLAYER.COUNTRY_ID
