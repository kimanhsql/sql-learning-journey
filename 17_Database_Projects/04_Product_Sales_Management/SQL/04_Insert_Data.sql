...
INSERT INTO CUSTOMERS(CustomerID,FullName,Address,PhoneNumber,DateOfBirth,RegistrationDate,SalesAmount,LOAIKH)
	VALUES
...
INSERT INTO EMPLOYEES(EmployeeID,FullName,PhoneNumber,HireDate)
	VALUES
...
INSERT INTO PRODUCTS(ProductID,ProductName,Unit,CountryOfOrigin,Price)
	VALUES
...
INSERT INTO INVOICES(InvoiceID, InvoiceDate, CustomerID, EmployeeID, TotalAmount)
	VALUES
...
INSERT INTO INVOICE_DETAILS(InvoiceID, ProductID, Quantity)
	VALUES
		(1001,'TV02',10),
		(1001,'ST01',5),
		(1001,'BC01',5),
